        ...
        if not client.collections.exists(name):
            client.collections.create(
                ...
                properties=[
                    ...
                    Property(name="CID", data_type=DataType.TEXT, description="CID номер"),
                    Property(name="tags", data_type=DataType.TEXT, description="Теги"),
                    ...
                    Property(name="lastModified", data_type=DataType.TEXT, description="Дата последнего обновления"),
                    Property(name="registryUrl", data_type=DataType.TEXT, description=""),
                    Property(name="source", data_type=DataType.TEXT, description="Источник")
                ]
            )
